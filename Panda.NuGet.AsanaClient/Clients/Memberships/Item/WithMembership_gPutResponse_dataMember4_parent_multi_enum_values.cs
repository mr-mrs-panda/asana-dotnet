...
namespace Panda.NuGet.AsanaClient.Clients.Memberships.Item
{
    ...
    public partial class WithMembership_gPutResponse_dataMember4_parent_multi_enum_values : IAdditionalDataHolder, IParsable
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Panda.NuGet.AsanaClient.Clients.Memberships.Item.WithMembership_gPutResponse_dataMember4_parent_multi_enum_values"/> and sets the default values.
        /// </summary>
        public WithMembership_gPutResponse_dataMember4_parent_multi_enum_values()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Panda.NuGet.AsanaClient.Clients.Memberships.Item.WithMembership_gPutResponse_dataMember4_parent_multi_enum_values"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Panda.NuGet.AsanaClient.Clients.Memberships.Item.WithMembership_gPutResponse_dataMember4_parent_multi_enum_values CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Panda.NuGet.AsanaClient.Clients.Memberships.Item.WithMembership_gPutResponse_dataMember4_parent_multi_enum_values();
        }
        /// <summary>
