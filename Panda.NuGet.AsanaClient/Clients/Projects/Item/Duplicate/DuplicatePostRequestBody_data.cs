...
namespace Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate
{
    ...
    public partial class DuplicatePostRequestBody_data : IAdditionalDataHolder, IParsable
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data_schedule_dates? ScheduleDates { get; set; }
#nullable restore
#else
        public global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data_schedule_dates ScheduleDates { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data"/> and sets the default values.
        /// </summary>
        public DuplicatePostRequestBody_data()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "schedule_dates", n => { ScheduleDates = n.GetObjectValue<global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data_schedule_dates>(global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data_schedule_dates.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::Panda.NuGet.AsanaClient.Clients.Projects.Item.Duplicate.DuplicatePostRequestBody_data_schedule_dates>("schedule_dates", ScheduleDates);
